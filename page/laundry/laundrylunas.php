<div class="page-content-wrapper">
  <div class="container-fluid">
    ...
    <!-- Row untuk judul halaman dan breadcrumb -->
    <div class="row">
      <div class="col-sm-12">
        <!-- Box judul halaman dan navigasi -->
        <div class="page-title-box">
          <div class="btn-group float-right">
            <!-- Breadcrumb untuk navigasi halaman -->
            <ol class="breadcrumb hide-phone p-0 m-0">
              <li class="breadcrumb-item"><a href="#">Laundry</a></li>
              <li class="breadcrumb-item active">Data Transaksi Laundry Lunas</li>
            </ol>
          </div>
          <!-- Judul halaman -->
        ...
        <div class="card m-b-30">
          <div class="card-body">
            <div class="table-responsive">
              ...
              <!-- Tabel untuk menampilkan data transaksi laundry -->
              <table id="datatable" class="table table-bordered">
                ...
                <tbody>
                  <?php
                  // Query untuk menampilkan data transaksi yang sudah lunas
                  $query = "SELECT * FROM `tb_laundry` 
                            ...
                            WHERE `tb_laundry`.`status_pembayaran` = 1";
                  $result = mysqli_query($conn, $query);
                  $i = 1;
                  while ($row = mysqli_fetch_assoc($result)) :
                  ?>
                    <!-- Baris data untuk setiap transaksi -->
                    <tr>
                      ...
                      <td>
                        <?php if ($row['status_pengambilan'] == 0) { ?>
                          <!-- Tombol untuk menandai baju belum diambil -->
                        ...
                        <?php } elseif ($row['status_pengambilan'] == 1) { ?>
                          <!-- Tombol untuk menandai baju sudah diambil -->
                      ...
                      <td>
                        <?php if ($row['status_pembayaran'] == 1) { ?>
                          <!-- Tombol aksi jika transaksi sudah lunas -->
                        ...
                        <?php } elseif ($row['status_pembayaran'] == 0) { ?>
                          <!-- Tombol aksi jika transaksi belum lunas -->
                          <a href="?page=laundry&aksi=detail&id=<?= $row['id_laundry']; ?>" class="btn btn-primary mb-2"><i class="fa fa-eye"></i></a>
                          <a href="?page=laundry&aksi=lunasi&id=<?= $row['id_laundry']; ?>" class="btn btn-success mb-2" onclick="return confirm('Apakah anda yakin untuk melunasi ?');"><i class="fa fa-money"></i></a>
